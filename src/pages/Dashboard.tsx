  ...
  useEffect(() => {
    ...
    const fetchProfileName = async () => {
      ...
      if (error) {
        ...
        setUserName(data?.name ?? user.user_metadata?.name ?? "Usuário");
      }
    };
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`text-2xl font-bold ${totalBalance >= 0 ? "text-income" : "text-expense"}`}
                >
              ...
              {transactions?.slice(0, 8).map((tx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-8 h-8 rounded-lg flex items-center justify-center ${tx.type === "income" ? "bg-income-light" : "bg-expense-light"}`}
                    >
                      {tx.type === "income" ? (
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {format(new Date(tx.date + "T12:00:00"), "dd MMM", {
                          locale: ptBR,
                        })}
                      </p>
                    </div>
